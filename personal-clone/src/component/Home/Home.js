      ...
      <div className="home_main">
        ...
        <div className="panel_1">
          ...
          <div className="at_sundance">
            ...
            <p className="paragraph_tags">
              ...
              art and culture, spirit and service, is homegrown and available to
              all." - Robert Redford
            </p>
          </div>
        ...
        <div className="upcoming_events">
          ...
          <p>
            ...
            food and lodging. We offer a full calendar of events and activities
            for you to enjoy. Browse our calendar of events to plan your next
            trip, date or get-a-way.
          </p>
        ...
        <div className="lodging">
          ...
          <p>
            ...
            Mountain Resort. Enjoy the fresh air and the rejuvenating spirit of
            the mountains. Relax and unwind in your own private mountain home or
            one of our beautiful mountain suites.
          </p>
        </div>
        ...
        <div className="reserve_table">
          ...
          <p>
            Sundance Mountain Resort offers a wide variety of dining experience
            for all occasions. Dine in elegance at the Tree Room or enjoy the
            rustic atmosphere in the Foundry Grill or the casual scene at the
            Owl Bar. Our food is fresh and inspired, you’ll find yourself
            falling in love with the tastes, sounds and scene found at Sundance.
          </p>
